...
export const GameOverModalNative: React.FC<GameOverModalNativeProps> = ({
  isOpen,
  onClose,
  game,
  onRematch,
    ...
    <View className="flex-1 justify-between gap-4 bg-[#FDFBF7] p-5">
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ gap: 16, paddingBottom: 16 }}>
        ...
        <View className="flex-row items-end justify-center gap-2 pt-2">
          {/* 2nd Place */}
          {secondPlace && (
            <View className="flex-1 items-center gap-1 rounded-2xl border border-[#E5E0D8] bg-[#F7F4EE] p-3">
          ...
          {/* 1st Place */}
          {winner && (
            <View className="flex-[1.2] items-center gap-1 rounded-2xl border-2 border-[#E5A93C] bg-[#E5A93C]/15 p-3.5 shadow-sm">
      ...
      <View className="flex-row gap-2.5">
        ...
        <Pressable
          onPress={onClose}
          className="items-center justify-center rounded-2xl border border-[#E5E0D8] bg-white px-6 py-4"
        >
